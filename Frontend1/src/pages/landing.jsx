...
//   const [showSuccessDialog, setShowSuccessDialog] = useState(false);
//   const [generatedData, setGeneratedData] = useState(null);
//   const [dialogType, setDialogType] = useState("shorten"); // Track which action was performed
//   const [errors, setErrors] = useState({});
...
//       // Set dialog type to shorten
//       setDialogType("shorten");
...
//       // Set dialog type to QR
//       setDialogType("qr");
      
//       // For QR only, just show the dialog with QR code (no API call needed)
//       setGeneratedData({qr: longUrl, original_url: longUrl});
//       setShowSuccessDialog(true);
//     } catch (e) {
//       const newErrors = {};
...
//           {/* Show shortened link dialog for SHORTEN */}
//           {dialogType === "shorten" && generatedData ? (
//             <div className="space-y-4">
//               <p className="text-gray-600 text-sm pb-4">
//                 Copy the link below or choose platform to share it.
//               </p>
...
//             /* Show QR code dialog for GENERATE QR */
//             <div className="space-y-4">
//               <p className="text-gray-600 text-sm">
//                 Scan this QR code to access your link or download it.
//               </p>
...
import { QRCode } from "react-qrcode-logo";
import { Copy, Download, X, XIcon } from "lucide-react";
import * as yup from "yup";
import useFetch from "@/hooks/use-fetch";
import { createUrl } from "@/db/apiUrls";
import { BeatLoader } from "react-spinners";
...
const LandingPage = () => {
  ...
  const handleShortenClick = async (e) => {
    ...
    try {
      ...
      // ✅ Directly call create API (no create-dialog in between)
      setFormValues({
  ...
  return (
    <div className="relative flex flex-col items-center w-full">
      ...
      {/* ✅ Success Dialog - Directly after shortening */}
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
